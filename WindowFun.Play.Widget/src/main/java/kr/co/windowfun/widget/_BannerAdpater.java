...
public class _BannerAdpater extends RecyclerView.Adapter<_BannerAdpater.ViewHolder> implements _ENUM, _JSON {
    ...
    int _text_color = android.R.color.primary_text_dark; //default
    int _text_backcolor = android.R.color.transparent; //default
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        //item
        try {
            JSONObject2 item = new JSONObject2(items.get(position).toString());
            ...
            _text_color = android.R.color.primary_text_dark; //default
            _text_backcolor = android.R.color.transparent; //default
            //text_...
            ...
            _text_color = Color.parseColor(!item.isNullString(result_c.text_color) ? item.getString(result_c.text_color) : String.format("#%08X", 0xFFFFFFFF & _text_color));
            _text_backcolor = Color.parseColor(!item.isNullString(result_c.text_backcolor) ? item.getString(result_c.text_backcolor) : String.format("#%08X", 0xFFFFFFFF & _text_backcolor));
        } catch (Exception e) {
            e.printStackTrace();
        }
        //icon

...
public class CContent extends RelativeLayout {
     ...
     * @see #CContent(Context, AttributeSet, int)
     */
    public CContent(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        _CLASSNAME_ = this.getClass().getName();
        __CLASSNAME__ = "[[" + this.getClass().getName() + "]]";
    }
     ...
     * theme attribute. This constructor of CContent allows subclasses to use their
     ...
     * @see #CContent(Context, AttributeSet)
     */
    public CContent(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    /**
     * Perform inflation from XML and apply a class-specific base style from a
     * theme attribute or style resource. This constructor of CContent allows
    ...
    public CContent(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {

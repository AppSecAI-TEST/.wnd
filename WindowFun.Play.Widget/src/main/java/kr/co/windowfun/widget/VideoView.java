...
class VideoView extends android.widget.VideoView implements _CListener {
     ...
     * @see #VideoView(Context, AttributeSet, int)
     */
     ...
     * theme attribute. This constructor of VideoView allows subclasses to use their
     ...
     * @see #VideoView(Context, AttributeSet)
     */
    ...
    /**
     * Perform inflation from XML and apply a class-specific base style from a
     * theme attribute or style resource. This constructor of VideoView allows
